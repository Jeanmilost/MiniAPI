...
void UpdateScene(float elapsedTime)
{
    ...
    {
        // move bar polygons
        g_Bar.m_R.m_X += g_Bar.m_ExpROffset.m_X * (elapsedTime * 50.0f);
        g_Bar.m_R.m_Y += g_Bar.m_ExpROffset.m_Y * (elapsedTime * 50.0f);
        g_Bar.m_L.m_X -= g_Bar.m_ExpLOffset.m_X * (elapsedTime * 50.0f);
        g_Bar.m_L.m_Y += g_Bar.m_ExpLOffset.m_Y * (elapsedTime * 50.0f);
    ...
    // move ball
    g_Ball.m_Geometry.m_Pos.m_X += g_Ball.m_Offset.m_X * (elapsedTime * 50.0f);
    g_Ball.m_Geometry.m_Pos.m_Y += g_Ball.m_Offset.m_Y * (elapsedTime * 50.0f);
